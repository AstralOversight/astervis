"""
Django settings for astervis project.
...
ALLOWED_HOSTS = ["poc.fsdh-dhsf.science.cloud-nuage.canada.ca", "fsdh-proj-fewpm-webapp-poc.azurewebsites.net"] + os.environ.get("DJANGO_ALLOWED_HOSTS","127.0.0.1").split(",")
...
WSGI_APPLICATION = "astervis.wsgi.application"
